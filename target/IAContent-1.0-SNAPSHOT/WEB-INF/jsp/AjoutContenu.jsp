...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="<%= request.getContextPath() %>/redirectAjout">
                ...
                <div class="card mb-4">
                    <div class="card z-index-0">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3>Ajout d'intélligence artificielle</h3>
                        </div>
                        <div class="card-body">
                            <form role="form text-left" action="<%= request.getContextPath() %>/ajoutContenu" method="post">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Titre" aria-label="Titre" name="titre">
                                </div>
                                <div class="mb-3">
